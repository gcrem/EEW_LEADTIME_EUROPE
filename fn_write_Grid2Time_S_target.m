function fn_write_Grid2Time_S_target(station,station_lat,station_lon,station_depth,station_elev,target_lat,target_lon)
...
filename='Grid2Time_S.in';
fileID=fopen(filename,'w');

first_line = ['GTFILES  ./model/layer  ./time/layer S '];
